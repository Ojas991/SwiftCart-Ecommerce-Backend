...
public class ProductServiceImpl implements ProductService{
	...
	public ProductResponseDTO updateProduct(Long id, UpdateProductRequestDTO productRequestDTO) {
		...
		if(productRequestDTO.getName()==null 
			...
			throw new IllegalArgumentException("At least One feild should be present for Updation.");
		}
		...
		if(productRequestDTO.getPrice() != null) {
			if(productRequestDTO.getPrice()<0) {
				throw new IllegalArgumentException("Product Price cannot be Negative Blank.");
			}
		...
		if(productRequestDTO.getStockQuantity() != null) {
			if(productRequestDTO.getStockQuantity()<0) {
				throw new IllegalArgumentException("Product Stock Quantity cannot be Negative Blank.");
			}
		...
		if (productRequestDTO.getImageUrl() != null) {
		    if (productRequestDTO.getImageUrl().isBlank()) {
		        throw new IllegalArgumentException("Product Image URL cannot be left blank.");
		    }
	...
	//Create Pageable objects for pagination and sorting--->
